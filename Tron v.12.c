...
//Mobile goal stops
	...
	resetMotorEncoder(Left);
	resetMotorEncoder(Right);
	while(abs(getMotorEncoder(Right)) < getStraightGoal(115))
	{
		motor[Left]= 127;
		motor[Right]= 127;
	}
...
//Mobile goal stops
	...
	resetMotorEncoder(Left);
	resetMotorEncoder(Right);
	while(abs(getMotorEncoder(Right)) < getStraightGoal(112))
	{
		motor[Left]= -127;
		motor[Right]= -127;
	}
...
// The robot goes  backward from collecting the mobile goal
	...
	resetMotorEncoder(Left);
	resetMotorEncoder(Right);
	while(abs(getMotorEncoder(Right)) < getRotationGoal(220))
	{
		motor[Left]= -127;
		motor[Right]= 127;
	}
