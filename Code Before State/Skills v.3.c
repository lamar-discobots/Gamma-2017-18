...
//Forward pushing mobiles
	...
	motor[InstaL]= 0;
	motor[InstaR]=0;
//The mobile goal goes back into the robot
	...
	resetMotorEncoder(Left);
	resetMotorEncoder(Right);
	while(abs(getMotorEncoder(Right)) <getRotationGoal(
...
//The robot goes forward
	...
	motor[Left]= 0;
	motor[Right]= 0;
//The robot turns another 90 degrees
